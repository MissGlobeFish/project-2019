<template>
  <div class="dashboard-editor-container">
    ...
    <el-form :inline="true" :model="dashboardForm" ref="dashboardForm" class="demo-ruleForm" size="small">
      <el-form-item label="开始日期" prop="startTime">
        <el-date-picker v-model="dashboardForm.startTime" @change="startTimeChange" type="date" placeholder="选择日期"></el-date-picker>
      </el-form-item>
      <el-form-item label="结束日期" prop="endTime">
        <el-date-picker v-model="dashboardForm.endTime" :picker-options="pickerOptions" @change="endTimeChange" type="date" placeholder="选择日期"></el-date-picker>
      </el-form-item>
      <el-form-item>
        <el-button type="primary" @click="fetchData('dashboardForm')">查询</el-button>
      </el-form-item>
    </el-form>
  ...
  methods: {
    ...
    fetchData(formName){
      this.$refs[formName].validate((valid) => {
        if (valid) {
          /* statisticsBI(this.dashboardForm).then(response => {
