<template>
  <div class="app-container">
    ...
    >
        ...
        <el-table-column prop="title" label="设备名称" width="120" align="center"></el-table-column>
...
<script>
import { getList, addFacility, modifyFacility, searchFacility, registerLink, connectCamera, getParking } from '@/api/facilityList'
