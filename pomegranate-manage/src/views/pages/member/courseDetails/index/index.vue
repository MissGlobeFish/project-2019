  ...
  <d2-container :filename="filename" type="card">
    <template slot="header">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>课程活动明细</el-breadcrumb-item>
      </el-breadcrumb>
    </template>
    ...
    <template>
      <div class="containerBox">
        ...
        <el-form :inline="true" :model="formInline" class="demo-form-inline">
          <el-form-item label="">
            <el-input v-model="formInline.id" placeholder="订单号、用户ID、券号、课程活动编号"></el-input>
          </el-form-item>
          <el-form-item label="">
        ...
        <el-table :data="tableData" v-loading="loading" border :header-cell-style="{background:'#F9F9F9',color:'#323232',}" height="600" style="width: 100%;">
          ...
          <el-table-column prop="name" label="交易类型" width="80" align="center"></el-table-column>
          ...
          <el-table-column prop="lastCreateTime" label="应付金额" width="80" align="center"></el-table-column>
          <el-table-column prop="openid" label="扣减金额" width="80" align="center"></el-table-column>
          <el-table-column prop="amount" label="实付金额" width="80" align="center"></el-table-column>
          <el-table-column prop="lastCreateTime" label="课程/活动编号" width="200" align="center"></el-table-column>
          <el-table-column prop="openid" label="券的类型" width="80" align="center"></el-table-column>
          <el-table-column prop="lastCreateTime" label="券的名称" width="200" align="center"></el-table-column>
          <el-table-column prop="openid" label="券的编号" width="200" align="center"></el-table-column>
        </el-table>
