...
//TODO : 点击进入 APP 以及应用前台收到推送的情况，需要在以下方法中添加处理
...
- (void)xgPushUserNotificationCenter:(UNUserNotificationCenter *)center
    ...
    //------------------TEST-----------------//
    [RNGFXGPushModel sharedInstance].userInfo = response;
    
    [self sendEventWithName:RNGFDidLaunchAppByOpenNotification body: response.notification.request.content.userInfo];
...
- (void)xgPushUserNotificationCenter:(UNUserNotificationCenter *)center
    ...
    //------------------TEST-----------------//
    [self sendEventWithName:RNGFDidReceiveRemoteNotification body:notification.request.content.userInfo];
...
RCT_EXPORT_METHOD(setBadge:(NSInteger)badgeNumber) {
    [[XGPush defaultManager] setBadge:(NSInteger)badgeNumber];
}
