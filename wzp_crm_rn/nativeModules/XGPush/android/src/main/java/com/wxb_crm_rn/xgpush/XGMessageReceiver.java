...
public class XGMessageReceiver extends  XGPushBaseReceiver {
    ...
    public static final String XGActionNotification = "com.wxb_crm_rn.xgpush.XG-Notification";
    public static final String XGActionCustomNotification = "com.wxb_crm_rn.xgpush.XG-CustomNotification";
    public static final String XGActionUnregister = "com.wxb_crm_rn.xgpush.XG-Unregister";
    public static final String XGActionRegistration = "com.wxb_crm_rn.xgpush.XG-Registration";
    public static final String XGActionTagSetting = "com.wxb_crm_rn.xgpush.XG-TagSetting";
    public static final String XGActionTagDeleting = "com.wxb_crm_rn.xgpush.XG-TagDeleting";
    public static final String XGActionClickNotification = "com.wxb_crm_rn.xgpush.XG-ClickNotification";
