...
export default class Receipt extends Component {
  ...
  handleListDidSelectedCellAtIndex( index, item ) {
    ...
    var formPageNav = global.getFormPageFromFormId(formId)
    if (formPageNav) {
      let param = {
        fId: item.fid
      }
  ...
  // 获取进行中初始列表数据
  handleInit() {
    this.setState({ refreshing: true,isLoadingMore: true,isAction: true })
