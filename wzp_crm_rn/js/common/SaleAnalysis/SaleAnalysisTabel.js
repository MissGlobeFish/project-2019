...
class SaleAnalysisTabelHeaderView extends Component {
    ...
    render() {
        ...
        return (
            <View ref="HeaderBackView" style={[{ zIndex: 99, backgroundColor: '#fff', width: 100 }, showShadows ? styles.scrollBoxShadow : null]}>
                <TouchableOpacity
...
export default class SaleAnalysisTabel extends Component {
    ...
    rowContentRender() {
        ...
        this.state.headerDataList = headerDataList
        var isOneScreenShown = headerDataList.length <= 3
        //指数标题
        let headers = headerDataList.map((data, index) => {
            return (
                <TouchableOpacity
                    ...
                    isOneScreenShown ? { width: (screenWidth - cityNameBoxWith - 20) / headerDataList.length, justifyContent: 'center' } : null
                    ]}
                            ...
                            return (
                                <TouchableOpacity
                                    style={
                                        ...
                                        isOneScreenShown ? { width: (screenWidth - cityNameBoxWith - 20) / headerDataList.length, alignItems: 'center' } : null
                                        ]}
